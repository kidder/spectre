...
DataVector n_dot_v(
  ...
  DataVector n_dot_v = get<0>(normal_covector) * get<0>(grid::v(x, t));
  for (size_t i = 1; i < Dim; ++i) {
    n_dot_v += normal_covector.get(i) * grid::v(x, t).get(i);
  }
  return n_dot_v;
}
...
void Var1::normal_dot_flux(
  ...
  if constexpr (UseMovingMesh) {
    get(*normal_dot_flux) -=
        sign * n_dot_v(normal_covector, x, t) * wave::f(x, t);
  }
}
...
void Var1::dt_value(const gsl::not_null<type*> dt_var1,
  ...
  if constexpr (UseMovingMesh) {
    for (size_t i = 0; i < Dim; ++i) {
      dt_var1->get() +=
          grid::v(x, t).get(i) * gsl::at(wave::k<Dim>, i) * wave::df(x, t);
    }
  }
}
...
void Var2<Dim>::normal_dot_flux(
  ...
  for (size_t i = 0; i < Dim; ++i) {
    ...
    if constexpr (UseMovingMesh) {
      normal_dot_flux->get(i) -= sign * n_dot_v(normal_covector, x, t) *
                                 gsl::at(wave::k<Dim>, i) *
                                 square(wave::f(x, t));
    }
  }
    ...
    for (size_t d = 0; d < Dim; ++d) {
      for (size_t i = 0; i < Dim; ++i) {
        dt_var2->get(d) += 2.0 * gsl::at(wave::k<Dim>, d) * wave::f(x, t) *
                           grid::v(x, t).get(i) * gsl::at(wave::k<Dim>, i) *
                           wave::df(x, t);
      }
    }
  }
...
template void Var1::normal_dot_flux<true>(
    const gsl::not_null<Scalar<DataVector>*> normal_dot_flux,
...
template void Var1::normal_dot_flux<true>(
    ...
    const double sign);
template void Var1::normal_dot_flux<false>(
    const gsl::not_null<Scalar<DataVector>*> normal_dot_flux,
    const tnsr::i<DataVector, 1, Frame::Inertial>& normal_covector,
    const tnsr::I<DataVector, 1, Frame::Inertial>& x, const double t,
    const double sign);
...
template void Var2<1>::normal_dot_flux<true>(
    const gsl::not_null<tnsr::I<DataVector, 1, Frame::Inertial>*>
        normal_dot_flux,
    const tnsr::i<DataVector, 1, Frame::Inertial>& normal_covector,
    const tnsr::I<DataVector, 1, Frame::Inertial>& x, const double t,
    const double sign);
template void Var2<2>::normal_dot_flux<true>(
    const gsl::not_null<tnsr::I<DataVector, 2, Frame::Inertial>*>
        normal_dot_flux,
    const tnsr::i<DataVector, 2, Frame::Inertial>& normal_covector,
    const tnsr::I<DataVector, 2, Frame::Inertial>& x, const double t,
    const double sign);
template void Var2<3>::normal_dot_flux<true>(
    const gsl::not_null<tnsr::I<DataVector, 3, Frame::Inertial>*>
        normal_dot_flux,
    const tnsr::i<DataVector, 3, Frame::Inertial>& normal_covector,
    const tnsr::I<DataVector, 3, Frame::Inertial>& x, const double t,
    const double sign);
template void Var2<1>::normal_dot_flux<false>(
    const gsl::not_null<tnsr::I<DataVector, 1, Frame::Inertial>*>
        normal_dot_flux,
    const tnsr::i<DataVector, 1, Frame::Inertial>& normal_covector,
    const tnsr::I<DataVector, 1, Frame::Inertial>& x, const double t,
    const double sign);
template void Var2<2>::normal_dot_flux<false>(
    const gsl::not_null<tnsr::I<DataVector, 2, Frame::Inertial>*>
        normal_dot_flux,
    const tnsr::i<DataVector, 2, Frame::Inertial>& normal_covector,
    const tnsr::I<DataVector, 2, Frame::Inertial>& x, const double t,
    const double sign);
template void Var2<3>::normal_dot_flux<false>(
    const gsl::not_null<tnsr::I<DataVector, 3, Frame::Inertial>*>
        normal_dot_flux,
    const tnsr::i<DataVector, 3, Frame::Inertial>& normal_covector,
    const tnsr::I<DataVector, 3, Frame::Inertial>& x, const double t,
...
template void Var1::dt_value<true>(
...
template void Var1::dt_value<true>(
    const gsl::not_null<type*> dt_var1,
    const tnsr::I<DataVector, 3, Frame::Inertial>& x, const double t);
template void Var1::dt_value<false>(
    const gsl::not_null<type*> dt_var1,
    const tnsr::I<DataVector, 1, Frame::Inertial>& x, const double t);
template void Var1::dt_value<false>(
    const gsl::not_null<type*> dt_var1,
...
template void Var2<1>::dt_value<true>(
    const gsl::not_null<type*> dt_var2,
    const tnsr::I<DataVector, 1, Frame::Inertial>& x, const double t);
template void Var2<2>::dt_value<true>(
    const gsl::not_null<type*> dt_var2,
    const tnsr::I<DataVector, 2, Frame::Inertial>& x, const double t);
template void Var2<3>::dt_value<true>(
    const gsl::not_null<type*> dt_var2,
    const tnsr::I<DataVector, 3, Frame::Inertial>& x, const double t);
template void Var2<1>::dt_value<false>(
    const gsl::not_null<type*> dt_var2,
    const tnsr::I<DataVector, 1, Frame::Inertial>& x, const double t);
template void Var2<2>::dt_value<false>(
    const gsl::not_null<type*> dt_var2,
    const tnsr::I<DataVector, 2, Frame::Inertial>& x, const double t);
template void Var2<3>::dt_value<false>(
    const gsl::not_null<type*> dt_var2,
    const tnsr::I<DataVector, 3, Frame::Inertial>& x, const double t);
